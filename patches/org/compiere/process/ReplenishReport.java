...
//		End Dixon Martinez
	...
	private void createPO()
	{
		...
		for (int i = 0; i < replenishs.length; i++)
		{
			...
			line.setPrice();
			line.saveEx();
//			Added by Dixon Martinez 2015-11-20
//			Set document no from PO into Temporal Replenish
			replenish.set_ValueOfColumn("DocumentNo", order.getDocumentNo());
			replenish.save();
//			End Dixon Martinez
		}
...
//			Added by Dixon Martinez 2015-11-20
//			Set document no from PO into Temporal Replenish
			replenish.set_ValueOfColumn("DocumentNo", requisition.getDocumentNo());
			replenish.save();
//			End Dixon Martinez
		}
		m_info = "#" + noReqs + info;
...
//				Added by Dixon Martinez 2015-11-20
//				Set document no from PO into Temporal Replenish
				replenish.set_ValueOfColumn("DocumentNo", move.getDocumentNo());
				replenish.save();
//				End Dixon Martinez
				//
