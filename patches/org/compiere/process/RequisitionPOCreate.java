...
public class RequisitionPOCreate extends SvrProcess
{
	...
	private void newLine(MRequisitionLine rLine) throws Exception
	{
		...
		if (product != null)
		{
			...
			/*
			 * Yamel Senih 20/04/2012 14:15
			 * Correction unit of measure and price
			 */
			
			m_orderLine.setC_UOM_ID(rLine.getC_UOM_ID());
			m_orderLine.setPriceEntered(rLine.getPriceActual());
			BigDecimal PriceActual = MUOMConversion.convertProductTo (getCtx(), m_orderLine.getM_Product_ID(), 
					m_orderLine.getC_UOM_ID(), rLine.getPriceActual());
			m_orderLine.setPriceActual(PriceActual);
		}
		else
		{
