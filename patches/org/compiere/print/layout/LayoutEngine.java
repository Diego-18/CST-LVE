...
public class LayoutEngine implements Pageable, Printable, Doc
{
		...
		int xOffset)
	{
		...
		//	
		float m_horizontalGap = 0;
		float m_verticalGap = 0;
		//	Yamel Senih 2015-02-02
		//	Add Dynamic Horizontal and Vertical Gap
		BigDecimal g_value = (BigDecimal) tf.get_Value("HorizontalGap");
		if(g_value != null)
			m_horizontalGap = g_value.floatValue();
		//	
		g_value = (BigDecimal) tf.get_Value("VerticalGap");
		if(g_value != null)
			m_verticalGap = g_value.floatValue();
		//	End Yamel Senih
	...
	//	System.out.println("Rows=" + rows);
		...
		TableElement table = new TableElement(columnHeader,
			...
			tf, pageBreak, colSuppressRepeats, m_horizontalGap, m_verticalGap);
