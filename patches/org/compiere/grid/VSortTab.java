...
//						m_IdentifierTranslated = true;
					...
					AD_Reference = rs.getInt(9);
					if (identifierSql.length() > 0)
						identifierSql.append("||'_'||");

					if(DisplayType.isNumeric(AD_Reference)){
						identifierSql.append("COALESCE(");
						identifierSql.append(getIdentifier(rs.getString(1), rs.getString(3), rs.getInt(2),isTranslated));
						identifierSql.append(",NULL)");
					}else if(DisplayType.isText(AD_Reference)){
						identifierSql.append("COALESCE(");
						identifierSql.append(getIdentifier(rs.getString(1), rs.getString(3), rs.getInt(2),isTranslated));
						identifierSql.append(",'')");
					}else if(DisplayType.isDate(AD_Reference)){
						identifierSql.append("COALESCE(");							
						identifierSql.append(DB.TO_CHAR(getIdentifier(rs.getString(1), rs.getString(3), rs.getInt(2),isTranslated).toString(), AD_Reference, Env.getAD_Language(Env.getCtx())));
						identifierSql.append(",'')");					
					}else{
						identifierSql.append(getIdentifier(rs.getString(1), rs.getString(3), rs.getInt(2),isTranslated));
					}
...
//					End Dixon Martinez
	...
	{
		//	2015-07-08 Dixon Martinez
		//	Add Support for tabs Resize order list
		mainLayout.rowWeights = new double[]{0.0, 1.0, 1.0, 0.0, 0.0};
		mainLayout.columnWeights = new double[]{1.0, 0.0, 1.0, 0.0};
		//	End Dixon Martinez
...
//				,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(4, 4, 4, 4), 0, 0));
		...
		this.add(bRemove,  new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0
				,GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(4, 4, 5, 5), 0, 0));
//		End Dixon Martinez
		
		this.add(noPane,      new GridBagConstraints(0, 1, 1, 4, 0.0, 0.0
				,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 4, 4, 5), 0, 0));
		this.add(yesPane,      new GridBagConstraints(2, 1, 1, 4, 0.0, 0.0
				,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 4, 4, 5), 0, 0));
...
//				,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(4, 4, 4, 4), 0, 0));
		this.add(bUp,  new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0
				,GridBagConstraints.SOUTH, GridBagConstraints.NONE, new Insets(4, 4, 5, 4), 0, 0));
		
//		this.add(bAdd,  new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0
//				,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(4, 4, 4, 4), 0, 0));
		this.add(bAdd,  new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0
				,GridBagConstraints.SOUTH, GridBagConstraints.NONE, new Insets(4, 4, 5, 5), 0, 0));
		...
		this.add(bDown,         new GridBagConstraints(3, 2, 1, 1, 0.0, 0.0
				,GridBagConstraints.NORTH, GridBagConstraints.ABOVE_BASELINE, new Insets(4, 4, 5, 4), 0, 0));
