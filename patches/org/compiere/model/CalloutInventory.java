...
//	End Dixon Martinez
	...
	public String uom (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value){
		...
		Integer p_MProduct_ID = (Integer)mTab.getValue("M_Product_ID");
		// if product is not null
		if (p_MProduct_ID!= null) {
			int uom = DB.getSQLValue(null, "SELECT C_Uom_ID FROM M_Product WHERE M_Product_ID = "+p_MProduct_ID);
	...
	public String docType (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value){		
		...
		//	Set value Is Internal
		mTab.setValue("IsInternal", m_DocType.get_ValueAsBoolean("IsInternal"));
