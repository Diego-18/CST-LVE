...
public class MBankStatement extends X_C_BankStatement implements DocAction
{
	...
	public boolean voidIt()
	{
		...
		MBankAccount ba = getBankAccount();
		ba.load(get_TrxName());
		ba.setCurrentBalance(ba.getCurrentBalance().subtract(
				//Carlos Parada Sustract Zero When DocStatus is Drafted
				//getStatementDifference()
				(getDocStatus().equals(MBankStatement.DOCSTATUS_Drafted)?Env.ZERO:getStatementDifference()))
