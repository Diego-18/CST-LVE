 ...
 *    Yamel Senih - ERP Consultores y Asociados, C.A.                         *
 *    	Add Payment Export Support                                            *
 *****************************************************************************/
...
public class PayPrint {
	...
	public ArrayList<KeyNamePair> getPaySelectionData()
	{
		...
		//	Yamel Senih 03/11/2013 
		//	Add Change SQL, hide generated Payments
		String sql = "SELECT ps.C_PaySelection_ID, ps.Name || ' - ' || ps.TotalAmt " +
				...
				"GROUP BY ps.C_PaySelection_ID, ps.Name, ps.TotalAmt " +
