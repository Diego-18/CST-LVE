...
public class MHRMovement extends X_HR_Movement
{
	...
	public MHRMovement (X_I_HR_Movement impHRm)
	{
		...
		MHREmployee employee  = MHREmployee.getActiveEmployee(getCtx(), impHRm.getC_BPartner_ID(), impHRm.getAD_Org_ID(), get_TrxName());
	...
	public void setColumnValue(Object value)
	{
		...
		{
			throw new AdempiereException("@Script Error@ @Value@ " 
					+ concept.getValue());
		}
	}
