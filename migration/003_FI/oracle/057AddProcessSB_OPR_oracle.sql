...
INSERT INTO AD_Process (AccessLevel,AD_Client_ID,AD_Org_ID,AD_Process_ID,Classname,CopyFromProcess,Created,CreatedBy,EntityType,IsActive,IsBetaFunctionality,IsDirectPrint,IsReport,IsServerProcess,Name,ShowHelp,Statistic_Count,Statistic_Seconds,Updated,UpdatedBy,Value) VALUES ('3',0,0,53661,'org.spin.process.PaymentRequestCreateFrom','N',TO_DATE('2014-07-16 15:15:02','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','N','N','N','N','Open Payment','Y',0,0,TO_DATE('2014-07-16 15:15:02','YYYY-MM-DD HH24:MI:SS'),100,'PR_OpenPayment')
;
