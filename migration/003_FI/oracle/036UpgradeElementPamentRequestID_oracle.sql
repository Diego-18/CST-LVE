...
-- LVE EFT
UPDATE AD_Element SET Name='Payment Request',Updated=TO_DATE('2014-07-09 16:47:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57250
;
...
-- 9/07/2014 04:47:23 PM VET
-- LVE EFT
UPDATE AD_PrintFormatItem pi SET PrintName='LVE Payment Request ID', Name='Payment Request' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=57250)
;

-- 9/07/2014 04:47:47 PM VET
-- LVE EFT
UPDATE AD_Element_Trl SET Name='Solicitud de Pago',PrintName='Solicitud de Pago',Updated=TO_DATE('2014-07-09 16:47:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57250 AND AD_Language='es_MX'
;
