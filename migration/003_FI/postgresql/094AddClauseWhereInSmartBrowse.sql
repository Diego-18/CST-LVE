...
AND NOT EXISTS (
		...
		WHERE
			...
			AND pr.RequestType = op.RequestType
	)',Updated=TO_TIMESTAMP('2014-09-22 10:58:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Browse_ID=50039
;
...
AND NOT EXISTS (
		...
		WHERE
			...
			AND pr.RequestType = op.RequestType
			AND pr.LVE_PaymentRequest_ID = @LVE_PaymentRequest_ID@
	)',Updated=TO_TIMESTAMP('2014-09-22 11:00:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Browse_ID=50039
;
