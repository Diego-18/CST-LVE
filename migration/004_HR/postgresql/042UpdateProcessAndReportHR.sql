...
-- LVE HR
UPDATE AD_Element_Trl SET Name='Telefono',PrintName='Telefono',Updated=TO_TIMESTAMP('2013-09-27 16:56:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56392 AND AD_Language='es_MX'
;

-- 27/09/2013 04:57:03 PM VET
-- LVE HR
UPDATE AD_Element_Trl SET Name='Telefono2',PrintName='Telefono2',Updated=TO_TIMESTAMP('2013-09-27 16:57:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=56393 AND AD_Language='es_MX'
;
...
-- LVE HR
UPDATE AD_Process_Trl SET Name='Empleado',Updated=TO_TIMESTAMP('2013-09-27 16:58:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53471 AND AD_Language='es_MX'
;

-- 27/09/2013 05:01:15 PM VET
-- CGI Anca
UPDATE AD_ReportView SET Name='LVE_RV_HR_EmployeeDetail',Updated=TO_TIMESTAMP('2013-09-27 17:01:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_ReportView_ID=53064
;
