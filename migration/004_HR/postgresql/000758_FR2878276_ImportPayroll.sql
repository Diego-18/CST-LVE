...
-- Feb 8, 2010 6:19:10 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD AD_Client_ID NUMERIC(10) DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:14 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD AD_Org_ID NUMERIC(10) DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:15 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD Amount NUMERIC DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:16 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD C_BPartner_ID NUMERIC(10) DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:19 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD CreatedBy NUMERIC(10) DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:20 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD HR_Concept_ID NUMERIC(10) DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:21 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD HR_Process_ID NUMERIC(10) DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:24 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD Qty NUMERIC DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:26 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD TextMsg VARCHAR(255) DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:28 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD UpdatedBy NUMERIC(10) DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:29 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD I_IsImported VARCHAR(1) DEFAULT 'N' NOT NULL
;
...
-- Feb 8, 2010 6:19:30 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD I_ErrorMsg VARCHAR(2000) DEFAULT NULL 
;
...
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD BPartner_Value VARCHAR(40) DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:35 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD ConceptValue VARCHAR(40) DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:37 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD HR_Movement_ID NUMERIC(10) DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:38 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD ProcessName VARCHAR(60) DEFAULT NULL 
;
...
-- Feb 8, 2010 6:19:39 PM COT
-- FR2878276-Importer for Payroll
ALTER TABLE I_HR_Movement ADD Description VARCHAR(255) DEFAULT NULL 
;
