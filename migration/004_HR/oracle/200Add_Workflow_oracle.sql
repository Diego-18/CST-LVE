...
-- HR Loan
UPDATE AD_Element SET Name='HR Loan Amortization', PrintName='HR Loan Amortization',Updated=TO_DATE('2015-01-19 08:44:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57756
;
...
-- Jan 19, 2015 8:44:31 AM EST
-- HR Loan
UPDATE AD_PrintFormatItem pi SET PrintName='HR Loan Amortization', Name='HR Loan Amortization' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=57756)
;

-- Jan 19, 2015 8:45:48 AM EST
-- HR Loan
UPDATE AD_Element_Trl SET Name='Amortización',PrintName='Amortización',Updated=TO_DATE('2015-01-19 08:45:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57756 AND AD_Language='es_MX'
;

-- Jan 19, 2015 8:46:00 AM EST
-- HR Loan
UPDATE AD_Element SET Name='Amortization', PrintName='Amortization',Updated=TO_DATE('2015-01-19 08:46:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57756
;
...
-- HR Loan
UPDATE AD_PrintFormatItem pi SET PrintName='Amortization', Name='Amortization' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=57756)
;

-- Jan 19, 2015 8:46:29 AM EST
-- HR Loan
UPDATE AD_Element SET Name='HR Loan', PrintName='HR Loan',Updated=TO_DATE('2015-01-19 08:46:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57754
;
...
-- Jan 19, 2015 8:46:30 AM EST
-- HR Loan
UPDATE AD_PrintFormatItem pi SET PrintName='HR Loan', Name='HR Loan' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=57754)
;

-- Jan 19, 2015 8:46:50 AM EST
-- HR Loan
UPDATE AD_Element_Trl SET Name='Préstamo a Empleado',PrintName='Préstamo a Empleado',Updated=TO_DATE('2015-01-19 08:46:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57754 AND AD_Language='es_MX'
;

-- Jan 19, 2015 8:47:02 AM EST
-- HR Loan
UPDATE AD_Element SET Name='HR Loan Payment Term', PrintName='HR Loan Payment Term',Updated=TO_DATE('2015-01-19 08:47:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57755
;
...
-- Jan 19, 2015 8:47:02 AM EST
-- HR Loan
UPDATE AD_PrintFormatItem pi SET PrintName='HR Loan Payment Term', Name='HR Loan Payment Term' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=57755)
;

-- Jan 19, 2015 8:47:22 AM EST
-- HR Loan
UPDATE AD_Element_Trl SET Name='Término de Pago de Préstamo',PrintName='Término de Pago de Préstamo',Updated=TO_DATE('2015-01-19 08:47:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57755 AND AD_Language='es_MX'
;

-- Jan 19, 2015 8:56:17 AM EST
-- HR Loan
INSERT INTO AD_Workflow (AccessLevel,AD_Client_ID,AD_Org_ID,AD_Table_ID,AD_Workflow_ID,Author,Cost,Created,CreatedBy,Description,DocumentNo,Duration,DurationUnit,EntityType,IsActive,IsBetaFunctionality,IsDefault,IsValid,Name,PublishStatus,Updated,UpdatedBy,Value,Version,WaitingTime,WorkflowType,WorkingTime) VALUES ('1',0,0,53922,50045,'Adempiere, Inc.',0,TO_DATE('2015-01-19 08:56:10','YYYY-MM-DD HH24:MI:SS'),100,'(Standard Process HR Loan)','10000000',1,'D','ECA02','Y','N','N','N','Process_HR_Loan','R',TO_DATE('2015-01-19 08:56:10','YYYY-MM-DD HH24:MI:SS'),100,'Process_HR_Loan',0,0,'P',0)
;
...
-- HR Loan
UPDATE AD_Process_Trl SET Name='Procesar Préstamo a Empleado',Updated=TO_DATE('2015-01-19 08:57:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53734 AND AD_Language='es_MX'
;

-- Jan 19, 2015 8:57:16 AM EST
-- HR Loan
UPDATE AD_Column SET AD_Process_ID=53734,Updated=TO_DATE('2015-01-19 08:57:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=75436
;

-- Jan 19, 2015 8:58:45 AM EST
-- HR Loan
UPDATE AD_Workflow_Trl SET IsTranslated='Y',Name='Proceso de Préstamo',Description='(Proceso de Préstamo Estándar)',Updated=TO_DATE('2015-01-19 08:58:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Workflow_ID=50045 AND AD_Language='es_MX'
;

-- Jan 19, 2015 8:59:37 AM EST
-- HR Loan
INSERT INTO AD_WF_Node (Action,AD_Client_ID,AD_Org_ID,AD_WF_Node_ID,AD_Workflow_ID,Cost,Created,CreatedBy,Description,DocAction,Duration,DynPriorityChange,EntityType,IsActive,IsCentrallyMaintained,IsMilestone,IsSubcontracting,JoinElement,Limit,MovingTime,Name,OverlapUnits,Priority,QueuingTime,SetupTime,SplitElement,UnitsCycles,Updated,UpdatedBy,Value,WaitingTime,WaitTime,WorkingTime,XPosition,Yield,YPosition) VALUES ('D',0,0,50205,50045,0,TO_DATE('2015-01-19 08:59:34','YYYY-MM-DD HH24:MI:SS'),100,'(Standard Node)','--',0,0,'ECA02','Y','Y','N','N','X',0,0,'(DocAuto)',0,0,0,0,'X',0,TO_DATE('2015-01-19 08:59:34','YYYY-MM-DD HH24:MI:SS'),100,'(DocAuto)',0,0,0,0,100,0)
;
...
-- HR Loan
INSERT INTO AD_WF_Node (Action,AD_Client_ID,AD_Org_ID,AD_WF_Node_ID,AD_Workflow_ID,Cost,Created,CreatedBy,Description,DocAction,Duration,DynPriorityChange,EntityType,IsActive,IsCentrallyMaintained,IsMilestone,IsSubcontracting,JoinElement,Limit,MovingTime,Name,OverlapUnits,Priority,QueuingTime,SetupTime,SplitElement,UnitsCycles,Updated,UpdatedBy,Value,WaitingTime,WaitTime,WorkingTime,XPosition,Yield,YPosition) VALUES ('D',0,0,50206,50045,0,TO_DATE('2015-01-19 09:00:01','YYYY-MM-DD HH24:MI:SS'),100,'(Standard Node)','CO',0,0,'ECA02','Y','Y','N','N','X',0,0,'(DocComplete)',0,0,0,0,'X',0,TO_DATE('2015-01-19 09:00:01','YYYY-MM-DD HH24:MI:SS'),100,'(DocComplete)',0,0,0,0,100,0)
;
...
-- HR Loan
INSERT INTO AD_WF_Node (Action,AD_Client_ID,AD_Org_ID,AD_WF_Node_ID,AD_Workflow_ID,Cost,Created,CreatedBy,Description,DocAction,Duration,DynPriorityChange,EntityType,IsActive,IsCentrallyMaintained,IsMilestone,IsSubcontracting,JoinElement,Limit,MovingTime,Name,OverlapUnits,Priority,QueuingTime,SetupTime,SplitElement,UnitsCycles,Updated,UpdatedBy,Value,WaitingTime,WaitTime,WorkingTime,XPosition,Yield,YPosition) VALUES ('D',0,0,50207,50045,0,TO_DATE('2015-01-19 09:00:26','YYYY-MM-DD HH24:MI:SS'),100,'(Standard Node)','PR',0,0,'ECA02','Y','Y','N','N','X',0,0,'(DocPrepare)',0,0,0,0,'X',0,TO_DATE('2015-01-19 09:00:26','YYYY-MM-DD HH24:MI:SS'),100,'(DocPrepare)',0,0,0,0,100,0)
;
...
-- HR Loan
INSERT INTO AD_WF_Node (Action,AD_Client_ID,AD_Org_ID,AD_WF_Node_ID,AD_Workflow_ID,Cost,Created,CreatedBy,Description,DocAction,Duration,DynPriorityChange,EntityType,IsActive,IsCentrallyMaintained,IsMilestone,IsSubcontracting,JoinElement,Limit,MovingTime,Name,OverlapUnits,Priority,QueuingTime,SetupTime,SplitElement,UnitsCycles,Updated,UpdatedBy,Value,WaitingTime,WaitTime,WorkingTime,XPosition,Yield,YPosition) VALUES ('Z',0,0,50208,50045,0,TO_DATE('2015-01-19 09:01:08','YYYY-MM-DD HH24:MI:SS'),100,'(Standard Node)','CO',0,0,'ECA02','Y','Y','N','N','X',0,0,'(Start)',0,0,0,0,'X',0,TO_DATE('2015-01-19 09:01:08','YYYY-MM-DD HH24:MI:SS'),100,'(Start)',0,0,0,0,100,0)
;
...
-- HR Loan
INSERT INTO AD_WF_NodeNext (AD_Client_ID,AD_Org_ID,AD_WF_Next_ID,AD_WF_Node_ID,AD_WF_NodeNext_ID,Created,CreatedBy,Description,EntityType,IsActive,IsStdUserWorkflow,SeqNo,Updated,UpdatedBy) VALUES (0,0,50206,50207,50160,TO_DATE('2015-01-19 09:02:52','YYYY-MM-DD HH24:MI:SS'),100,'(Standard Transition)','ECA02','Y','N',10,TO_DATE('2015-01-19 09:02:52','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Jan 19, 2015 9:03:28 AM EST
-- HR Loan
INSERT INTO AD_WF_NodeNext (AD_Client_ID,AD_Org_ID,AD_WF_Next_ID,AD_WF_Node_ID,AD_WF_NodeNext_ID,Created,CreatedBy,Description,EntityType,IsActive,IsStdUserWorkflow,SeqNo,Updated,UpdatedBy) VALUES (0,0,50207,50208,50161,TO_DATE('2015-01-19 09:03:25','YYYY-MM-DD HH24:MI:SS'),100,'(Standard Approval)','ECA02','Y','Y',10,TO_DATE('2015-01-19 09:03:25','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Jan 19, 2015 9:04:23 AM EST
-- HR Loan
INSERT INTO AD_WF_NodeNext (AD_Client_ID,AD_Org_ID,AD_WF_Next_ID,AD_WF_Node_ID,AD_WF_NodeNext_ID,Created,CreatedBy,Description,EntityType,IsActive,IsStdUserWorkflow,SeqNo,Updated,UpdatedBy) VALUES (0,0,50205,50208,50162,TO_DATE('2015-01-19 09:04:13','YYYY-MM-DD HH24:MI:SS'),100,'(Standard Transition)','ECA02','Y','N',100,TO_DATE('2015-01-19 09:04:13','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Jan 19, 2015 9:04:40 AM EST
-- HR Loan
UPDATE AD_Workflow SET AD_WF_Node_ID=50208, IsValid='Y',Updated=TO_DATE('2015-01-19 09:04:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Workflow_ID=50045
;
