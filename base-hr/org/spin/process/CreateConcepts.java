...
import org.spin.model.MLVEHRProcessReportLine;
import org.spin.model.X_LVE_HR_ProcessReport;

/**
 * @author <a href="mailto:dixon.22martinez@gmail.com">Dixon Martinez</a> 
 *
 */
public class CreateConcepts extends SvrProcess {
	...
	protected String doIt() throws Exception {
		...
		if(conceptsPayroll != null)
			for (MHRPayrollConcept mhrPayrollConcept : conceptsPayroll) {
				MHRConcept conecpt = (MHRConcept) mhrPayrollConcept.getHR_Concept();
				if(conecpt == null)
					continue;
				
				if(conecpt.isPrinted() ||
						conecpt.isPaid()) {
					if(!existsConceptProcessReport(conecpt.getHR_Concept_ID())) {
						...
						m_LVE_ProcessReportLine.setSeqNo(mhrPayrollConcept.getSeqNo());;
