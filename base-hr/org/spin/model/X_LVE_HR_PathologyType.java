...
/** Generated Model for LVE_HR_PathologyType
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS (1252452765) - $Id$ */
public class X_LVE_HR_PathologyType extends PO implements I_LVE_HR_PathologyType, I_Persistent 
{
    ...
    public X_LVE_HR_PathologyType (Properties ctx, int LVE_HR_PathologyType_ID, String trxName)
    {
      super (ctx, LVE_HR_PathologyType_ID, trxName);
      /** if (LVE_HR_PathologyType_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_LVE_HR_PathologyType (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_LVE_HR_PathologyType[")
