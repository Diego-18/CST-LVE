...
public interface I_I_HR_Employee 
{
    ...
    /** Column name HR_Department_Value */
    public static final String COLUMNNAME_HR_Department_Value = "HR_Department_Value";
    ...
    /** Column name HR_Job_Value */
    public static final String COLUMNNAME_HR_Job_Value = "HR_Job_Value";

	/** Set Job Value	  */
	public void setHR_Job_Value (String HR_Job_Value);

	/** Get Job Value	  */
	public String getHR_Job_Value();
    ...
    /** Column name HR_Payroll_Value */
    public static final String COLUMNNAME_HR_Payroll_Value = "HR_Payroll_Value";

	/** Set Payroll Value	  */
	public void setHR_Payroll_Value (String HR_Payroll_Value);

	/** Get Payroll Value	  */
	public String getHR_Payroll_Value();
	...
	/** Set Payroll Employee Import	  */
	public void setI_HR_Employee_ID (int I_HR_Employee_ID);

	/** Get Payroll Employee Import	  */
